...
procedure TfTaskPlan.CheckThreads;
var
  i: Integer;
begin
...
var
  ...
  function FindInterval(aID : Variant) : Boolean;
  var
    i: Integer;
  begin
    Result := False;
    for i := 0 to aResource.IntervalCount-1 do
      if TPInterval(aResource.Interval[i]).Id=aId then
        begin
          Result := True;
          break;
        end;
            ...
            begin
              while not EOF do
                begin
                  ...
                  and (not FindInterval(bTasks.Id.AsVariant))
                  then
                    begin
